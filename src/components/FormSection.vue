<template>
    <main class="w-full px-4 mt-10 mb-[50px]">
        ...
        <div>
          ...
          <div class="bg-white rounded-2xl p-6 border border-black-100 max-w-md mx-auto ml-[200px]">
            <form @submit.prevent="submitForm" class="flex flex-col gap-4">
              ...
              <div class="flex items-start space-x-2">
                <input type="checkbox" :checked="form.agree" @click.prevent="showModal = true" class="mt-1" required />
              ...
              <button type="submit" :disabled="!isFormValid"
                class="w-full text-sm font-medium py-2 rounded-lg text-white focus:font-semibold disabled:bg-gray-400 h-[54px]"
