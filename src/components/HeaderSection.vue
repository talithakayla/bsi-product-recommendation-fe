<template>
  <header class="bg-white shadow sticky top-0 z-50">
    <div class="max-w-7xl mx-auto py-4 px-6 flex justify-between items-center pl-[100px]">
      <div class="flex items-center space-x-2">
        <img src="../assets/Bank_Syariah_Indonesia.svg.png" alt="BSI Logo" class="w-[215px] h-[60px]" />
      </div>
